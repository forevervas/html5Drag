...
<!--  <script src="//apps.bdimg.com/libs/jquery/1.10.2/jquery.min.js"></script>
  ...
  <style>
      body {font-family:arial, 'Hiragino Sans GB', 'Microsoft Yahei', '微软雅黑', '宋体', 5b8b4f53, Tahoma, Arial, Helvetica, STHeiti;}
...
<ul id="sortable1" class="connectedSortable">
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="ui-state-default" id="a_<?php echo ($v["id"]); ?>">
	<div class="divlink">
		<a href=<?php echo ($v["link"]); ?>><em class="link-word"><?php echo ($v["link_word"]); ?></em></a>
	</div>
    <a href="<?php echo U('Index/delete?aid='.$v['id']);?>" class="ui-icon ui-icon-close" title="删除"></a>
    ...
    <li class="ui-state-default add"><a href="javascript:" class="ui-icon ui-icon-circle-plus aadd">添加</a></li>
     ...
     <div class="form-group">
        <form method="post" action="<?php echo U('Admin/Index/add');?>">
